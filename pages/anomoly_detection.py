...
def app():
    ...
    if 'analyzed_df' in st.session_state:
        ...
        cols = ['ref_id', 'lof_predicted_fraud', 'lof_scores', 'lof_scores_normalized'] + [col for col in outliers_df.columns if col not in ['ref_id', 'lof_predicted_fraud','lof_scores','lof_scores_normalized']]
